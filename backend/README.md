...
## Project Structure
    ...
    ├── test_app_on_demand__38111  # Django project configurations
...
1. Clone this repo and `cd test_app_on_demand__38111`
...
2. Clone this repo and `cd test_app_on_demand__38111`
